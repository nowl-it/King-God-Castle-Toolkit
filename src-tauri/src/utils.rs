...
/// Kiểm tra xem path có phải là directory không
...
pub fn is_image_file(filename: &str) -> bool {
    const IMAGE_EXTENSIONS: &[&str] = &[
        "jpg", "jpeg", "png", "gif", "bmp", "svg", "webp", "ico", "tiff", "tga",
    ];
...
/// Kiểm tra xem file có phải là code file không
pub fn is_code_file(filename: &str) -> bool {
    const CODE_EXTENSIONS: &[&str] = &[
        "rs", "js", "ts", "jsx", "tsx", "py", "java", "c", "cpp", "h", "hpp", "cs", "php", "rb",
        "go", "swift", "kt", "scala", "clj", "hs", "elm", "vue", "svelte", "html", "css", "scss",
...
mod tests {
    ...
    fn test_file_extensions() {
        ...
        assert!(is_document_file("doc.pdf"));
